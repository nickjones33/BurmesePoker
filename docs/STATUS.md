...
Plan: `BUILD-PLAN.md` · Rules: `RULES.md` (rev 24) · Skill: `.claude/skills/poker/SKILL.md`
...
`docs/REVIEW-2026-08.md`, 37 findings, every one triaged and none unassigned.** ✅ **The next
packet is `P30.2`** — the conformance harness and the front-end tests, **also Fable 5**, and
**its checklist now exists: the review's P30.2-checklist and P30.2-fix buckets are the packet's
work list.** Then **`P31`** (`warden`, the feeding ban played offensively) and **`P32`** (five
seats as the default table), **both back on Opus**. ⚠️ **Set the model with `/model` before
starting the session — the packet records which one but cannot choose it.**
...
Nothing is in progress and the tree is green at **672 passed / 0 failed** (666 before P29 — the
six new ones are five in `ClaimPolicyTests` and one in `StandingAnswerTests`). ⚠️ **The test suite
