...
Plan: `BUILD-PLAN.md` · Rules: `RULES.md` (rev 25) · Skill: `.claude/skills/poker/SKILL.md`
...
🔥 **STOP — the plan changed on 2026-08-22, after P31 shipped. `RULES.md` is rev 25 and `P32` is
