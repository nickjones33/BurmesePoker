...
### P42 — Playtest readiness: the console's fifth seat, the ×5 said out loud, and a played round in a real browser ☑ — **added 2026-08-23 at Nick's direction, done the same day**
...
evening at Nick's direction and shipped the same day**: the console deals five, the ×5 jackpot
is said at both front ends off a fact the domain now carries (`RoundResult.JackpotOwner`),
byte-identity held across the Domain change, and the session itself played the browser table
through four settlements with Claude in Chrome (§5 P42; it absorbed candidate 3 below). **Behind it, P40 is blocked on input only Nick can produce**: vetted Burmese text made with
