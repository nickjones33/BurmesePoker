...
internal class GameMaster
{
    ...
    private void StartTurn(Player currentPlayer, Player? previousPlayer, Player nextPlayer)
    {
        ...
        {
            HandleFirstTurn(currentPlayer);
        }
        else
        {
            HandleNormalTurn(currentPlayer, previousPlayer);
        }
    ...
    private void HandleNormalTurn(Player currentPlayer, Player previousPlayer)
    {
        ...
        HandlePlayerDiscard(currentPlayer);
    }
    private void HandleFirstTurn(Player currentPlayer)
    {
